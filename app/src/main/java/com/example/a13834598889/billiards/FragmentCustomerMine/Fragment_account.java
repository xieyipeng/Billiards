...
public class Fragment_account extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        editText_age.setText("22");
        editText_emile.setText("971106029@qq.com");
        editText_nickName.setText("Century");
        editText_signature.setText("折磨人的不是离别而是忘不了的回忆，它很容易让你站在原地以为还回得去。");
