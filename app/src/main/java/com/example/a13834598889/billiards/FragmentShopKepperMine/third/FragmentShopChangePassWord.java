...
public class FragmentShopChangePassWord extends Fragment {
    ...
    public static FragmentShopChangePassWord newInstance(){
        FragmentShopChangePassWord fragmentShopChangePassWord =new FragmentShopChangePassWord();
        return fragmentShopChangePassWord;
    }
