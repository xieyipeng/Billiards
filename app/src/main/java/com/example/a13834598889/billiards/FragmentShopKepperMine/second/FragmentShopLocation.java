...
import com.example.a13834598889.billiards.xieyipeng.RegisterActivity;
...
public class FragmentShopLocation extends Fragment {
    ...
    public class MyLocationListener2 implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation bdLocation) {
            ...
            locationNowLongitude.setText("经度：" + Longitude);
            locationNowLatitude.setText("纬度：" + Latitude);
...
//                    Log.e(TAG, "run: location " + location + " " + location.length());
                    ...
                    locationNowMessage.post(new Runnable() {
                        @Override
                        public void run() {
                            locationNowMessage.setText("店铺位置：" + location);
                        }
                    });
                }
            }).start();
